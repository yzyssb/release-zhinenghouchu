...
const ZfEditModal = ({
    ...
    return (
        <Modal {...modalOpts} key={lszfgl.modalKey} afterClose={() => {
          
            dispatch({
                type: 'lszfgl/updatePayload', payload: {
                    modalKey: Date.now(),
                ...
                <Form horizontal className={styles.formwidth}>
                    ...
                    >
                        {getFieldDecorator('name', {
                            initialValue: lszfgl.foodMethodItemEdit.name,
                            rules: [
                                 {
                                    validator: (rule, value, callback) => {
                                        if (lszfgl.id) {
                                           dispatch({
                                                type: 'lszfgl/checkName',
                                                payload: {"callback": callback, "value": value,"id":lszfgl.id}
                                            });
                                        } else {
                                            dispatch({
                                                type: 'lszfgl/checkName',
                    ...
                    >
                        {getFieldDecorator('state', {
                            initialValue: lszfgl.foodMethodItemEdit.status,
                            rules: [{
                    ...
                    >
                        {getFieldDecorator('pricingType', {
                            initialValue: (lszfgl.currentSelectValue ? lszfgl.currentSelectValue + "" : "0"),
                            rules: [{
                                required: true, message: '请输入快递单号',
                            }],
                        })(
                        ...
                        <div>
                            ...
                            >
                                {getFieldDecorator('pricingRate', {
                                    initialValue: lszfgl.foodMethodItemEdit.pricingRate,
                                    rules: [{
                                        required: true, message: '请输入快递单号',
                                    }],
                                })(
                        ...
                        <div>
                            ...
                            >
                                {getFieldDecorator('pricingMoney', {
                                    initialValue: lszfgl.foodMethodItemEdit.pricingMoney/100,
                                    rules: [{
                                        required: true, message: '请输入快递单号',
                                    }],
                                })(
