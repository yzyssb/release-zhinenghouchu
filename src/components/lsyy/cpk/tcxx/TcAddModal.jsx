...
const CpAddModal = ({
 ...
 const formItemLayout = {
  ...
  function onLeftClick(a){
    ...
    dispatch({type: 'lstcxx/queryFoodByCategory',payload:{id:a.id}});

  }
  
  var children = []; 

  var cpflList = {...lscpfl.list};
  var objcet = {
    id:0,
    name:'全部分类'
  };
    ...
    afterClose:()=>resetFields()
      ...
      const modalProps = {
        ...
        function firstHandleNext(){
             ...
             dispatch({type: 'lstcxx/updatePayload',payload:{currentSteps:1}});
        ...
        function secondHandleNext(){
             ...
             dispatch({type: 'lstcxx/updatePayload',payload:{currentSteps:2}});
        ...
        function thirdHandleNext(){
             ...
             dispatch({type: 'lstcxx/updatePayload',payload:{currentSteps:3}});
             dispatch({type: 'lstcxx/queryFoodComboAdd',payload:{}});
        ...
        function fourHandlePrevious(){
             ...
             dispatch({type: 'lstcxx/updatePayload',payload:{modalVisible:false}});
             dispatch({type: 'lstcxx/updatePayload',payload:{currentSteps:0}});
        ...
        function addOption(record,index){
            ...
            var lastEmptyIndex=0;
             ...
             if(lastEmptyIndex>index){
                ...
                lstcxx.selectFoodList.splice(index+1, 0, {});
             ...
             dispatch({type: 'lstcxx/updatePayload',payload:{selectFoodList:lstcxx.selectFoodList,parentId:record.id}});
        }
  ...
  const rowSelection = {
    ...
    function onAddClick(){
      ...
      dispatch({type: 'lstcxx/updatePayload',payload:{selectFoodList:selectedList,selectedRowKeys:[]}});
  ...
  function onImgChange(e) {
      ...
      if(e.previewImage &&e.previewImage.length>0 && e.previewImage[0].response && e.previewImage[0].response.data){
          lstcxx.food.imgUrl  = e.previewImage[0].response.data;
  ...
  return (
    <Modal style={{height:"600px",overflowY:"auto",paddingBottom:"0"}} {...modalOpts} key={lstcxx.modalKey} afterClose={() => {
            // !!!!
    ...
    <div className={styles.pay}>
        <Steps current={lstcxx.currentSteps} style={{padding:"0 10px",marginBottom:"30px"}}>
         ...
         <div style={{display: lstcxx.currentSteps == 3 ? "block" : "none", textAlign: "center",fontSize:"20px",marginTop:"40px"}}>
