...
//弹框
    ...
    yxhdConfig.timeArray&&yxhdConfig.timeArray.length >0 &&yxhdConfig.timeArray.map((i,j)=>{
        ...
        timeChildren.push(
                ...
                <div key = {j}>
                    <TimePicker disabled value={moment(i.startTime, format)} onChange = {(time, timeString)=>{
                    ...
                    <span>&nbsp;&nbsp;至&nbsp;&nbsp;</span>
                    <TimePicker disabled value={moment(i.endTime, format)} format={format} onChange = {(time, timeString)=>{
                    ...
                    <Button disabled type = 'primary' style = {{marginLeft:10}} onClick = {()=>{
            ...
            <Form style={{padding: "20px"}} id="cjzhForm">
                ...
                <Form.Item  {...formItemLayout} label="活动名称" extra="如：会员日双倍积分；">
                    {getFieldDecorator('name', {
                        ...
                        <div>
                            <Input disabled style={{height: "32px", width: "350px"}} value = {yxhdConfig.cpfjf_name}  onChange = {(e)=>{
                                dispatch({
                                    type: "yxhdConfig/updatePayload",
                                    payload: {
                ...
                <Form.Item  {...formItemLayout} label="活动类型">
                    {getFieldDecorator('activityType', {
                        ...
                        <div>
                            <RadioGroup disabled onChange = {onRadioChange} defaultValue = {["3"]} value = {""+yxhdConfig.cpfjf_pointsType}>
                            ...
                            <div style = {{display:yxhdConfig.cpfjf_pointsType==3?'block':'none'}}>
                                ...
                                <Select disabled style = {{width:80}} defaultValue = {17} value = {yxhdConfig.cpfjf_day} onChange = {(value)=>{
                            ...
                            <div style = {{display:yxhdConfig.cpfjf_pointsType==2?'block':'none'}}>
                                ...
                                <CheckboxGroup disabled style={{ textAlign: "left" }} value = {yxhdConfig.cpfjf_week&&yxhdConfig.cpfjf_week.length>0&&yxhdConfig.cpfjf_week.split(',')} onChange = {(checkedValues)=>{
                            ...
                            <div>
                                <Button disabled type={"primary"} onClick={onAdd}>新增时段</Button>
                                {timeChildren}
                            </div>
                        </div>
                ...
                <Form.Item  {...formItemLayout} label="积分返还规则">
                    ...
                    (
                        <div>
                            <div>
                                <span>注册会员&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;返还比例：</span>
                                <InputNumber disabled style = {{width:150}} min={0} max={Infinity} step={0.1} precision={1}  value = {yxhdConfig.cpfjf_disVipPercent} onChange = {(e)=>{
                                    dispatch({
                                        type: "yxhdConfig/updatePayload",
                                        payload: {
                            ...
                            <div>
                                <span>付费会员&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;返还比例：</span>
                                <InputNumber disabled style = {{width:150}} min={0} max={Infinity} step={0.1} precision={1} value = {yxhdConfig.cpfjf_vipPercent} onChange = {(e)=>{
                                    dispatch({
                                        type: "yxhdConfig/updatePayload",
                                        payload: {
                                            cpfjf_vipPercent: e,
                            ...
                            <div>
                                <span>企业员工&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;返还比例：</span>
                                <InputNumber disabled style = {{width:150}} min={0} max={Infinity} step={0.1} precision={1} value = {yxhdConfig.cpfjf_companyPercent} onChange = {(e)=>{
                                    dispatch({
                                        type: "yxhdConfig/updatePayload",
                                        payload: {
                ...
                >
                    <Button disabled type="primary" onClick={showStoreListModal}>选择合适的门店</Button>
                ...
                <FormItem {...formItemLayout}
                          ...
                          style={{ textAlign: 'left' }}
                >
                    <Button disabled style={{ textAlign: 'left' }} type="primary" onClick={showGoodListModal}>选择合适的产品</Button>
                ...
                <Form.Item  {...formItemLayout} label="适用渠道">
                    {getFieldDecorator('useScene', {
                        ...
                        <div>
                            <Checkbox.Group disabled onChange={onChangeUseScene } defaultValue = {["1"]}>
                 ...
                 {/*<Form.Item  {...formItemLayout} label="活动推送">*/}
                     ...
                     {/*<div>*/}
                        {/*<Checkbox.Group disabled onChange={onChangeisPush} defaultValue = {["1"]}>*/}
                ...
                <Form.Item  {...formItemLayout} label="活动说明" extra = "活动描述限制输入200个字">
                    {getFieldDecorator('activityDesc', {  
                        ...
                        <div>
                            <TextArea disabled rows={4} style={{ width: "100%"}} value = {yxhdConfig.cpfjf_activityDesc} onChange = {(e)=>{
                ...
                <Row>
                    <Col span="3" offset="10">
                        <FormItem>
                            <Button disabled type="primary" onClick={saveInfo}>保存</Button>
                        </FormItem>
                    </Col>
                    <Col span="3">
                        <FormItem>
