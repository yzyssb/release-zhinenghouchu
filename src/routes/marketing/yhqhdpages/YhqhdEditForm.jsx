...
const YhqhdFormDetail = ({
  ...
  if (yhqhdConfig.periodValidityStart == "" && yhqhdConfig.periodValidityFinish == "") {
    rangPickerinitialValue = ""

  } else if (yhqhdConfig.periodValidityStart == 0 && yhqhdConfig.periodValidityFinish == 0) {
    rangPickerinitialValue = ""
  } else {
    rangPickerinitialValue = [moment(yhqhdConfig.formatDate(yhqhdConfig.periodValidityStart), "YYYY-MM-DD HH:mm:ss"), moment(yhqhdConfig.formatDate(yhqhdConfig.periodValidityFinish), "YYYY-MM-DD HH:mm:ss")]
  }
  ...
  function changeCouponMold(e) {
    ...
    // 菜品券下由折扣券切换为直抵券默认展示直抵券下面的全部抵扣
    if (yhqhdConfig.couponType == 2 && e.target.value == 2) {
      console.log(213)
      dispatch({
        type: "yhqhdConfig/updatePayload",
        payload: {
  ...
  function saveInfo() {
    ...
    validateFields((errors) => {
      ...
      confirm({
        title: '确认提示',
        okText: "确认保存",
        content: '编辑的优惠券被使用后将不能修改优惠券内容,请仔细核对',
        onOk() {
          // 整理请求参数
          let payload = {};
          payload.id = yhqhdConfig.currentRecord.id;
          ...
          dispatch({
            type: "yhqhdConfig/checkNameIsRepeat",
            payload: { name, id: yhqhdConfig.currentRecord.id }
          })
        },
        onCancel() {
        },
      ...
      <Form style={{ padding: "20px" }} id="cjzhForm">
        ...
        <Form.Item  {...formItemLayout} label="优惠券名称"  >
          {getFieldDecorator('name', {
            initialValue: yhqhdConfig.currentRecord.name,
            rules: [{
        ...
        <Form.Item  {...formItemLayout} label="优惠券类型"  >
          {getFieldDecorator('couponType', {
            ...
            <Select onChange={changeCouponType} disabled={true}>
          ...
          <div>
            <Form.Item  {...formItemLayout} label="优惠券种类"  >
              {getFieldDecorator('couponMold', {
                ...
                <RadioGroup onChange={changeCouponMold} disabled={true}>
              ...
              <div>
                <Form.Item  {...formItemLayout} label="优惠券面值"  >
                  {getFieldDecorator('value', {
                    initialValue: yhqhdConfig.currentRecord.value / 100,
                    rules: [{
              ...
              <div>
                <Form.Item  {...formItemLayout} label="优惠券折扣" extra="注：折扣比例范围1-100之间并且限制整数,如85即为8.5折">
                  {getFieldDecorator('discountRate', {
                    initialValue: yhqhdConfig.currentRecord.discountRate,
                    rules: [{
                ...
                {yhqhdConfig.isDeductAll == 0 &&
                  <Form.Item  {...formItemLayout} label="部分抵扣金额"  >
                    {getFieldDecorator('deductMoney', {
                      initialValue: yhqhdConfig.currentRecord.deductMoney / 100,
        ...
        {(yhqhdConfig.couponType == 1 && yhqhdConfig.couponMold == 1) &&
          <Form.Item  {...formItemLayout} label="最低消费" extra="满足多少消费金额可用" >
            {getFieldDecorator('minMoney', {
              initialValue: yhqhdConfig.currentRecord.minMoney / 100,
              rules: [{
        ...
        {yhqhdConfig.periodValidityType == 1 ?
          ...
          <Form.Item  {...formItemLayout} label="自发券之日起" extra="注：发券当天开始计算至第几天有效">
            {getFieldDecorator('periodValidityDays', {
              initialValue: yhqhdConfig.currentRecord.periodValidityDays,
              rules: [{
        ...
        <Form.Item  {...formItemLayout} label="适用场景"  >
          {getFieldDecorator('usageScenes', {
            initialValue: yhqhdConfig.currentRecord.usageScenes,
            rules: [{
          ...
          <div>
            <Form.Item  {...formItemLayout} label="优惠到期前"  >
              {getFieldDecorator('pushExpireDays', {
                initialValue: yhqhdConfig.currentRecord.pushExpireDays,
                rules: [{
        ...
        <Form.Item  {...formItemLayout} label="优惠券说明" extra="最多输入200个字">
          {getFieldDecorator('couponDesc', {
            initialValue: yhqhdConfig.currentRecord.couponDesc,
            rules: [{
        ...
        <Row>
          <Col span="3" offset="10">
            <FormItem >
              <Button type="primary" onClick={saveInfo}>保存修改</Button>
            </FormItem>
          </Col>
          <Col span="3">
            <FormItem >
