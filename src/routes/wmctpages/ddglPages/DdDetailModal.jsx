...
function DdDetailModal({ menu, dispatch, ddglConfig }) {
    const HeaderProps = {
        menu,
        dispatch,
    };
    ...
    function handleCancel() {
        dispatch({
            ...
            payload: { orderDetailModalVisible: false }
        });
    }
...
export default connect(mapStateToProps)(DdDetailModal);
